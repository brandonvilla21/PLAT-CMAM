	...
	<body onload="precargarPagina()">
		...
		<div id="div_contenedor_principal" >
			...
			<div id="div_cuerpo">
				...
				<h1>Modificación de datos del personal</h1><br/>
        <form name="frm_modificar_personal" >

          <label class="label_frm">Número de control:</label>
          <input name="id_personal" id="id_personal" type="text" class="input_frm" maxlength="9" required>
          <input name="bnt_buscar_personal" id="btn_buscar_personal" type="button" class="btn_frm_aceptar" value="Buscar personal" onclick="modificaPersonal()"/>
        </form>
